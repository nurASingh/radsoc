server {
	listen 80;
  listen [::]:80;
	server_name radiclesociety.com www.radiclesociety.com;
	location ^~ /.well-known {
      allow all;
      root  /data/letsencrypt/;
    }
	location / {
      return 301 https://radiclesociety.com$request_uri;
	}
}
server {
 	listen 443 ssl http2;
 	listen [::]:443 ssl http2;
	server_name www.radiclesociety.com;
...
server {
	server_name radiclesociety.com;
 	listen 443 ssl;
